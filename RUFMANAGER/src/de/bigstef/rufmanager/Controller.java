...
public class Controller extends Application{
    ...
    void register(final Context context, String name, String vname, final String regId) {
    	 
        Log.i(Config.TAG, "registering device (regId = " + regId + ")");
        
        String regUrl = Config.YOUR_SERVER_URL + "register.php";
     ...
     void unregister(final Context context, final String regId) {
        ...
        String serverUrl = Config.YOUR_SERVER_URL + "register.php/unregister";
        Map<String, String> params = new HashMap<String, String>();
        params.put("regId", regId);
   ...
   public void showAlertDialog(Context context, String title, String message,
	...
	public void postData(String lati, String longi, String id) {
	    // Create a new HttpClient and Post Header
		HttpParams params = new BasicHttpParams();
		HttpProtocolParams.setVersion(params, HttpVersion.HTTP_1_1);
	    HttpClient httpclient = new DefaultHttpClient(params);
	    HttpPost httppost = new HttpPost(Config.YOUR_SERVER_URL+"httppost.php");
	    ...
	    try {
	        ...
	        Log.v(Config.TAG, "Posting "+id);
	        

	        // Execute HTTP Post Request
	        HttpResponse response = httpclient.execute(httppost);
	        Log.v(Config.TAG, EntityUtils.toString(response.getEntity()));
    ...
    public void sendPos(String lat, String lon, final String regId){
        ...
        params.put("lat", lat);
        params.put("lon", lon);
        String adr=Config.YOUR_SERVER_URL+ "httppost.php";
